...
// objetos a partir de protótipos 
// no JS ele adota um sistema de construção de objetos, mas baseado nos protótipos 

// exemplos aplicando os conceitos de orientação de objeto raiz (da maneira certa)

// designer patner (padrão de desenho) - (modelo de código)

console.log('===CONSTRUCTOR PATNER===');
...
const cliente = new Conta(2501,006,1,100,"leticia", "C");

console.log(cliente);

// estudar violação exeção da regra construindo a função construtora.
